...
if (isset($_POST['submit2'])) {
	...
	$status = 0;
	$sql = "INSERT INTO tblbooking(PackageId,UserId,FromDate,ToDate,Comment,status) VALUES(:pid,:userid,:fromdate,:todate,:comment,:status)";
	...
	if ($lastInsertId) {
		// echo date('Y-m-d', strtotime($fromdate . ' + 1 days'));
		// echo gettype(date('Y-m-d', strtotime($fromdate . ' + 1 days')));
		// echo $fromdate;
		// echo gettype($fromdate);
